...
func main() {
	...
	mux.Handle("PUT /api/talents/{talentID}", cfg.middlewareAuth(http.HandlerFunc(cfg.handlerTalentsUpdate)))
	...
	mux.Handle("PUT /api/buyers/{buyerID}", cfg.middlewareAuth(http.HandlerFunc(cfg.handlerBuyersUpdate)))
